...
const Home = () => {
  ...
  const handleChange = (e) => {
    ...
    if(val)setValue(val.toLowerCase());
    else {
      setValue("")
    ...
    <div>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={6}>
          ...
          <TextField id="standard-basic" label="Nombre del Pokemon" onChange={handleChange} value={value}/>
            <Button color={"secondary"} style={{marginTop: 15}} onClick={handleSubmit} ><ArrowForwardIosIcon/></Button>
          </Paper>
        </Grid>
        <Grid item xs>
          <Paper className={classes.paper} elevation={0}></Paper>
